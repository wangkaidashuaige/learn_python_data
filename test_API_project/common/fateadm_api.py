...
def TestFunc():
    pd_id           = "137074"     #用户中心页可以查询到pd信息
    pd_key          = "k4izd1Yh60nzKpaKATCvZ4/P+HY1VA0D"
    app_id          = "100001"     #开发者分成用的账号，在开发者中心可以查询到
    app_key         = "123456"
    #识别类型，
    #具体类型可以查看官方网站的价格页选择具体的类型，不清楚类型的，可以咨询客服
    # pred_type = "30400" # 4位数字英文验证码
    # pred_type = "40600" # 6位汉字验证码
    pred_type = '50100' # 简单计算题
    # 10100 1 位纯数字
    ...
    # 通过文件形式识别：
    file_name = "D:\\test_API_project\\image\\dsmp_code1.png"      # 截取的验证码截图放在这里
    # file_name = os.getcwd().split("common"[0]+"dsmp_code1.png")
...
if __name__ == "__main__":
    r = TestFunc()
    print(r)
    # print(os.getcwd().split("common")[0]+"dsmp_code1.png")
